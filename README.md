...
Open NoC: Go to File > Open NoC and select test_noc.pkl.

Import Tasks: Go to Tasks > Import Tasks and select test_taches.pkl.

Run: Launch the simulation to observe node interactions.
